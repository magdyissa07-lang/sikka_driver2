...
const _categories = ['مشكلة في الصرف الأسبوعي', 'سلوك راكب', 'مشكلة في الرحلة', 'استفسار عن المستندات', 'استفسار عام'];
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setSheet) => Padding(
          ...
          child: Column(
            ...
            children: [
              const Text('تواصل مع الدعم الفني', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16)),
